<template>
    <div class="header">
        <div class="header-container">
            <div class="app-name">
                <router-link to="/">Nxx南小咸</router-link>
            </div>
            ...
            <el-button type="primary" icon="el-icon-plus"  @click="toRelease">发布</el-button>
    ...
    export default {
        ...
        data() {
            return {
                ...
                nickname:'登录',
                avatar:'https://cdn.jsdelivr.net/gh/Gxy-2001/img/seec2/20210503143842.jpg',
                isLogin:false
            };
        },
        created(){
